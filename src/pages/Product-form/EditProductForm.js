...
const EditProductform = (props) => {
  ...
  const productToEdit = useSelector((state) => state.product.EditProduct); // Select the product to edit from the Redux store
  ...
  const [discount, setDiscount] = useState(productToEdit.discount || "");
  const [quantity, setQantity] = useState(productToEdit.quantity || "");
